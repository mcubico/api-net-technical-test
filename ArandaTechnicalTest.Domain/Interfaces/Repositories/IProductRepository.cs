...
namespace ArandaTechnicalTest.Domain.Interfaces.Repositories
{
    public interface IProductRepository : IRepository<Products>
    {
        ...
        Task<IEnumerable<Products>> FilterAsync(int page, int itemsPerPage, string sortBy, bool directionAsc, string name);
        Task<IEnumerable<Products>> FilterAsync(int page, int itemsPerPage, string sortBy, bool directionAsc, string name, string description);
